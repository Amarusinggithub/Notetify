...
import { createAuthSlice, type AuthSlice } from '@/features/auth/store/auth-slice';
import { createNotesSlice, type NotesSlice } from '@/features/notes/store/note-slice';

import {
	createNotebookSlice,
	type NotebookSlice,
} from '@/features/notebooks/store/notebook-slice';
import { createTagSlice, type TagSlice } from '@/features/tags/store/tag-slice';
import {
	applyTheme,
	createThemeSlice,
	type ThemeSlice,
