...
import AuthProviderButtons from "@/shared/components/shared/auth-provider-buttons";
import InputError from "@/shared/components/shared/input-error.tsx";
import TextLink from "@/shared/components/shared/text-link.tsx";
import { Button } from "@/shared/components/ui/button.tsx";
import { Input } from "@/shared/components/ui/input.tsx";
import { Label } from "@/shared/components/ui/label.tsx";
import AuthLayout from "@/app/layouts/auth-layout.tsx";
import { useStore } from "@/app/store/index.ts";
import signUp  from "@/features/auth/hooks/use-signup";
import { registerSchema } from "@/features/auth/utils/validators";
...
const Register = () => {
    ...
    async function submit(e: React.SubmitEvent<HTMLFormElement>) {
        ...
        const isVerified =
            useStore.getState().sharedData?.auth.user.is_verified;
