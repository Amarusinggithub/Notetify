...
import { noteQueryOptions } from "@/features/notes/utils/query-options";
import { useCreateNote } from "@/features/notes/hooks/use-create-note.ts";
    ...
    useEffect(() => {
        ...
        if (firstNote) {
            queryClient.setQueryData(
                noteQueryKeys.detail(firstNote.id),
                firstNote,
            );
        }
