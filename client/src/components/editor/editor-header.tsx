            ...
            <div className="ml-auto flex items-center gap-3">
                            ...
                            <div className="bg-popover text-popover-foreground border-border rounded-2xl border p-4 shadow-xl">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Copy the note link or use your device
                                        share sheet.
                                    </p>
                                </div>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-64 rounded-2xl p-2">
                        ...
                        <DropdownMenuGroup className="space-y-1">
                            <DropdownMenuItem
                                onClick={() => console.log("Move note")}
                            >
                                <ArrowRightLeft className="mr-2 size-4" /> Move
                            </DropdownMenuItem>
                            <DropdownMenuItem
                                onClick={() => console.log("Copy note to")}
                            >
                        ...
                        <DropdownMenuGroup className="space-y-1">
                            ...
                            >
                                <FilePlus2 className="mr-2 size-4" /> Save as
                                Template
                            </DropdownMenuItem>
                            <DropdownMenuItem
                                onClick={() => console.log("Add to shortcuts")}
                            >
                                <Star className="mr-2 size-4" /> Add to
                                Shortcuts
                            </DropdownMenuItem>
                        ...
                        <DropdownMenuSub>
                            <DropdownMenuSubTrigger>
                                <ListTree className="mr-2 size-4" /> Collapsible
                                sections
                            </DropdownMenuSubTrigger>
                            <DropdownMenuSubContent>
                                <DropdownMenuItem
                        ...
                        <DropdownMenuGroup className="space-y-1">
                            <DropdownMenuItem
                                onClick={() => console.log("Find in note")}
                            >
                                <Search className="mr-2 size-4" /> Find in note
                            </DropdownMenuItem>
                            <DropdownMenuItem
                                onClick={() => console.log("Note info")}
                            >
                                <Info className="mr-2 size-4" /> Note info
                            </DropdownMenuItem>
                            <DropdownMenuItem
                                onClick={() => console.log("Note history")}
                            >
                        ...
                        <DropdownMenuItem
                            onClick={() => console.log("Print note")}
                        >
                            <Printer className="mr-2 size-4" /> Print
                        </DropdownMenuItem>
                        <DropdownMenuItem
                            disabled={
                                !currentUserNote || deleteNoteMutation.isPending
                            }
